        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center py-7">
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center items-center">
              <a className="group inline-flex items-center gap-3 px-14 py-4 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary text-primary-foreground rounded-full font-semibold transition-all duration-300 hover:scale-105 hover:shadow-l hover:shadow-primary/25">
