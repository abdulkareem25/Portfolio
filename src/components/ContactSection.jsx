            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  name="message"
                  required
                  className="hide-scrollbar w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-hidden foucs:ring-2 focus:ring-primary resize-none"
